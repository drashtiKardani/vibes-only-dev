...
import 'package:flutter_panel/src/util/crop_tool/crop_grid.dart';

/*
* All these three files (crop_image, crop_controller, crop_grid) are copied
* Entirely from https://github.com/deakjahn/crop_image
* So that we can modify it for our specific project purposes.
* */
...
class CropImage extends StatefulWidget {
  ...
  @override
  State createState() => _CropImageState();
