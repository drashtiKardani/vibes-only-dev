...
class ManifestReader {
  ...
  String _extractSubShortName(MethodElement method) {
    ...
    if (name == null) {
      throw ArgumentError("Method name cannot be null for $method");
    }
    ...
    require(
      ...
      () => "method name '$name' should be public",
    );
    require(
  ...
  String _extractFieldName(FormalParameterElement arg) {
    final name = arg.name;
    if (name == null) {
      throw ArgumentError("method argument name is null");
    }
  ...
  ManifestField _extractField(FormalParameterElement arg) {
  ...
  List<ManifestField> _extractFields(MethodElement method) =>
      method.formalParameters.map(_extractField).toList();
  ...
  List<ManifestField> _extractCommonFields() => topClass.fields
      .map((f) => f.getter)
      .whereType<PropertyAccessorElement>()
      .where(_filterGetterAccessors)
      .map((getter) =>
          _extractCommonField(getter)) // use _extractCommonField here
      .toList();

  /// filter getter accessors
  static bool _filterGetterAccessors(PropertyAccessorElement accessor) =>
      accessor.kind == ElementKind.GETTER;
  ...
  String _extractCommonFieldName(PropertyAccessorElement accessor) {
    ...
    if (name == null) {
      throw ArgumentError("Getter/field name cannot be null for $accessor");
    }
