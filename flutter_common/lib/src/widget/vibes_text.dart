...
class VibesText extends StatefulWidget {
  final Color? color;
  final String text;
  ...
  @override
  VibesTextState createState() => VibesTextState();
}

class VibesTextState extends State<VibesText> with TickerProviderStateMixin {
