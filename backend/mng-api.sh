...
PROJECT_NAME='vibes_only'
SERVER_NAME='digitalocean'
SERVER_PATH='/home/abol/projects/deploy/vibes-only/backend/'
...
NGINX_FILE='feat_vo_api_nginx.conf'
...
function create_admin_user() {
    docker exec -it ${API_CONTAINER_NAME} ./manage.py shell -c "from django.contrib.auth import get_user_model; get_user_model().objects.create_superuser(username='${1:-admin}', email='', password='${2:-test1234}')"
}
